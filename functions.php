...
function jpen_enqueue_assets() {
  ...
  wp_enqueue_style( 'startup-boostrap-css' , get_template_directory_uri() . './assets/css/main.css' );
  /* boostrap resources from theme files */
  wp_enqueue_style( 'bootstrap-css' , get_template_directory_uri() . './assets/css/font-awesome.min.css' );
  wp_enqueue_script( 'bootstrap-js' , get_template_directory_uri() . './assets/js/main.js' , array( 'jquery' ) , false , true );
